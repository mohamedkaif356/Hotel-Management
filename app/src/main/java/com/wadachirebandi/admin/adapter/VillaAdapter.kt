...
import com.wadachirebandi.admin.databinding.VillaItemViewBinding
import com.wadachirebandi.admin.ui.fragments.VillaFragmentDirections
    ...
    override fun onBindViewHolder(holder: VillaViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            villaCardView.setOnClickListener {
                val action =
                    VillaFragmentDirections.actionVillaFragmentToEntryFragment(
                        villaId = villa._id,
